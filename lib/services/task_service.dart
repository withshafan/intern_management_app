...
class TaskService {
  ...
  Future<Task> addTask(Task task) async {
    ...
    // The id is auto-generated by Firestore, but let's assume Task model handles parsing it via fromJson on read
    // For now we'll just return a copy with the docRef.id
    return Task(
      id: docRef.id,
